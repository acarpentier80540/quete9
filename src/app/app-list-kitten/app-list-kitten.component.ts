...
export class AppListKittenComponent implements OnInit {
  kitten: Array<Kitten> = [
    new Kitten(
      ...
      'poilue',
      '10.10.1984',
      'https://image.jimcdn.com/app/cms/image/transf/dimension=4000x3000:format=jpg/path/s5dde8bff85c81b2f/image/ia932f710bc9f0af9/version/1560445533/image.jpg',
      true
    ),
    new Kitten(
      'nunutte',
      'tigre',
      '10.10.1967',
      'https://img.le-dictionnaire.com/chaton-tigre.jpg',
      true
    ),
  ];
